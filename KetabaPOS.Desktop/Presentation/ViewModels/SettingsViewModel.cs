...
public partial class SettingsViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    private string _companyNameAr = string.Empty;
    ...
    private async Task BackupDatabaseAsync()
    {
        ...
        {
            var result = await _settingsService.BackupDatabaseAsync(dialog.FileName);
            StatusMessage = result ? "Backup created successfully!" : "Backup failed.";
        }
    }
    ...
    private async Task RestoreDatabaseAsync()
    {
        ...
        if (dialog.ShowDialog() == true)
        {
            var result = await _settingsService.RestoreDatabaseAsync(dialog.FileName);
            StatusMessage = result ? "Database restored successfully! Restart required." : "Restore failed.";
        }
    }
}
