...
public partial class DashboardViewModel : ObservableObject
{
    ...
    {
        IsLoading = true;
        try { var data = await _dashboardService.GetDashboardDataAsync(); TodaySales = data.TodaySales; TodayTransactions = data.TodayTransactions; LowStockProducts = data.LowStockProducts; ActiveLoans = data.ActiveLoans; TotalRevenue = data.TotalRevenue; SalesLast7Days = data.SalesLast7Days; RecentActivities = data.RecentActivities; }
