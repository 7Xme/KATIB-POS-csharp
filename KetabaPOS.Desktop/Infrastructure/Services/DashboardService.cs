...
public class DashboardService : IDashboardService
{
    ...
    public async Task<DashboardData> GetDashboardDataAsync()
    {
        ...
        return new DashboardData { TodaySales = todaySales, TodayTransactions = todayTransactions, LowStockProducts = lowStockCount, ActiveLoans = activeLoans, TotalRevenue = totalRevenue, SalesLast7Days = last7Days, RecentActivities = activities };
    }
}
